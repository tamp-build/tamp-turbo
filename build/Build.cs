...
#pragma warning restore CS0649
    ...
    readonly string SonarProjectKey = "tamp-build_tamp-turbo";
    ...
    Target Test => _ => _
        ...
        .Executes(() => DotNet.Test(s => s
            .SetProject(RootDirectory / "tests" / "Tamp.Turbo.V2.Tests" / "Tamp.Turbo.V2.Tests.csproj")
            .SetConfiguration(Configuration)
            .SetNoBuild(true)
    ...
    Target Pack => _ => _
        ...
        {
            s.SetProject(RootDirectory / "src" / "Tamp.Turbo.V2" / "Tamp.Turbo.V2.csproj");
